...
export function ToolCategoryCard({
  ...
  const glowClasses = {
    ...
    emerald: "hover:shadow-emerald-500/20 hover:ring-1 hover:ring-emerald-500/20",
    rose: "hover:shadow-rose-500/20 hover:ring-1 hover:ring-rose-500/20",
    violet: "hover:shadow-violet-500/20 hover:ring-1 hover:ring-violet-500/20",
  ...
  return (
    <article
      className={`group rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm transition-all duration-300 hover:border-zinc-300 hover:shadow-xl hover:-translate-y-1 dark:border-zinc-800 dark:bg-zinc-900/60 dark:hover:border-zinc-700 ${
        glowClasses[glowColor as keyof typeof glowClasses] ?? glowClasses.zinc
      } ${cardClassName ?? ""}`}
    >
